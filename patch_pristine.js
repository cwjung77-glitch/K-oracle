...
// Safely replace the UI section
const regex = /<p className="text-sm text-zinc-300 leading-relaxed">\s*\{result\.idolMatch\}\s*<\/p>\s*<\/div>\s*<\/div>\s*<\/div>/;
content = content.replace(regex, replacementStr);

// Safely remove the $11.99 banner
...
console.log("Safely applied UI patches with pristine UTF-8.");
